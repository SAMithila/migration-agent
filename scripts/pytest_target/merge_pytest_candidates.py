...
files = ["corpus/pytest_q2.json", "corpus/pytest_q3.json",
         "corpus/pytest_q8.json", "corpus/pytest_q9.json", "corpus/pytest_q10.json"]
...
with open("corpus/pytest_candidates.json", "w") as f:
    json.dump(candidates, f, indent=2)

print("\nWrote corpus/pytest_candidates.json")
